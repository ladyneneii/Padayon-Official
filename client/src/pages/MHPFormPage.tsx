...
const MHPFormPage = () => {
  ...
  useEffect(() => {
    ...
    if (unparsed_user_details) {
        ...
        try {
          ...
          if (response.ok) {
            ...
            if (result === "Nonexistent") {
              setErrMsg(
                "You cannot view this page because you are not registered as a mental health professional."
              );
            } else if (result === "Active" || result === "Unverified-1") {
              setErrMsg(
                "You cannot view this page because either you are not a mental health professional or you already filled out this form."
              );
      ...
      setErrMsg("You are not registered as a mental health professional.");
    }
  }, []);
  ...
  const handleVerify = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (user_details_str) {
      ...
      setErrMsg("You are not signed in. Please sign in first.");
    }
  };
